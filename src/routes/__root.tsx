...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Harsha Vardhan Raju Karapa | Data Analyst | Data Science | BI" },
      {
        name: "description",
        content:
      ...
      { name: "author", content: "Harsha Vardhan Raju Karapa" },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Harsha Vardhan Raju Karapa" },
